 ...
 * @see ClassRogue
 */
public class SubclassMarksman extends BaseSubclass {
	
	/**
	 * The static name of the subclass.
	 */
	public static final String CLASS_NAME = "Marksman";
	...
	public String getSublassDescription() {
		return "Offensive, Projectile Attacks";
	}
	...
	public ItemStack getSubclassItemStack() {
		return CharacterIconHeads.getMarksmanItem();
	}
