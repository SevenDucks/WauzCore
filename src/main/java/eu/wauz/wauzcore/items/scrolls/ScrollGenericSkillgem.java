 ...
 * Represensts a skillgem of unknown type. Can be dragged into equipment to insert it.
 * 
 * @author Wauzmons
 * 
 * @see WauzScrolls
...
public class ScrollGenericSkillgem implements InventoryScroll {
	...
	public boolean use(InventoryClickEvent event, String itemName) {
		return !itemName.contains("Unidentified") && WauzEquipment.insertSkillgem(event);
	}
