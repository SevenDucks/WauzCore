 ...
 * - Description: <b>Toggle Defense Debug Mode</b><br>
 * - Usage: <b>/wzDebug.defense [player]</b><br>
 ...
 */
@Command
public class CmdWzDebugDefense implements WauzCommand {
	...
	public List<String> getCommandIds() {
		return Arrays.asList("wzDebug.defense");
	}
	...
	public boolean executeCommand(CommandSender sender, String[] args) {
		...
		return WauzDebugger.toggleDefenseDebugMode(player);
	}
